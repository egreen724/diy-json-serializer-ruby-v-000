...
Post.create(title: "A Blog Post By Stephen King", description: post1)
Post.create(title: "I'm doing Great", description: post2)
Post.create(title: "Links Click Links", description: post3)
